# -*- coding: utf-8 -*-
"""
Created on Thu Dec 26 18:32:14 2019
...
# data_folder_name + image_id[i] + ext ( bu format dosyanın yolu )
...
def openImage():
    ...
    count += 1
    if count != 1:
        messagebox.showinfo(title = "Dikkat", message = "Sadece bir fotoğraf seçilebilir")
    else:
        img_name = filedialog.askopenfilename(initialdir = "D:\codes",title = "Bir Fotoğraf Seçiniz")
...
def classification():
    ...
    if img_name != "" and models.get() != "":
        ...
        messagebox.showinfo(title = "Warning", message = "Önce Fotoğrafı ve Modeli Seçiniz")
        tk.Label(frame3, text = "Fotoğrafı ve Modeli Seçiniz" ).place(relx = 0.1, rely = 0.6)
...
# frame 2 
# combo box
model_selection_label = tk.Label(frame2, text = "Sınıflandırma Modeli Seç: ")
...
entry.insert(string = "Kayıt İsmi...",index = 0)
